...
cmd /c call docker run -d -v %~dp0..\log\mysql-5.7-log:/var/log/mysql/ -p 3306:3306 -e MYSQL_ROOT_PASSWORD=root --net staticnet --ip 172.18.0.2 --name mysql57 mysql:5.7
cmd /c call docker run -d -v %~dp0..\log\mysql-8.0-log:/var/log/mysql/ -p 3307:3306 -e MYSQL_ROOT_PASSWORD=root --net staticnet --ip 172.18.0.3 --name mysql80 mysql:8.0.18
...
cmd /c call docker run -d -v %~dp0..\config\php-5.4-conf:/usr/local/etc -v %~dp0..\log\php-5.4-log:/usr/local/var/log -v %~dp0..\www:/var/www/html -p 9000:9000 --net staticnet --ip 172.18.0.4 --name php54 php:5.4-fpm
cmd /c call docker stop php54
cmd /c call docker run -d -v %~dp0..\config\php-5.5-conf:/usr/local/etc -v %~dp0..\log\php-5.5-log:/usr/local/var/log -v %~dp0..\www:/var/www/html -p 9000:9000 --net staticnet --ip 172.18.0.4 --name php55 php:5.5-fpm
cmd /c call docker stop php55
cmd /c call docker run -d -v %~dp0..\config\php-5.6-conf:/usr/local/etc -v %~dp0..\log\php-5.6-log:/usr/local/var/log -v %~dp0..\www:/var/www/html -p 9000:9000 --net staticnet --ip 172.18.0.4 --name php56 php:5.6-fpm
cmd /c call docker stop php56
cmd /c call docker run -d -v %~dp0..\config\php-7.0-conf:/usr/local/etc -v %~dp0..\log\php-7.0-log:/usr/local/var/log -v %~dp0..\www:/var/www/html -p 9000:9000 --net staticnet --ip 172.18.0.4 --name php70 php:7.0-fpm
cmd /c call docker stop php70
cmd /c call docker run -d -v %~dp0..\config\php-7.1-conf:/usr/local/etc -v %~dp0..\log\php-7.1-log:/usr/local/var/log -v %~dp0..\www:/var/www/html -p 9000:9000 --net staticnet --ip 172.18.0.4 --name php71 php:7.1-fpm
cmd /c call docker stop php71
cmd /c call docker run -d -v %~dp0..\config\php-7.2-conf:/usr/local/etc -v %~dp0..\log\php-7.2-log:/usr/local/var/log -v %~dp0..\www:/var/www/html -p 9000:9000 --net staticnet --ip 172.18.0.4 --name php72 php:7.2-fpm
cmd /c call docker stop php72
cmd /c call docker run -d -v %~dp0..\config\php-7.3-conf:/usr/local/etc -v %~dp0..\log\php-7.3-log:/usr/local/var/log -v %~dp0..\www:/var/www/html -p 9000:9000 --net staticnet --ip 172.18.0.4 --name php73 php:7.3-fpm
